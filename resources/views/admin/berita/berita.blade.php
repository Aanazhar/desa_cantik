...
@section('content')
    ...
    <div class="pub-admin-hero">
        ...
        <a class="pub-admin-add" href="{{ route('admin.berita.create') }}">
            ＋ Tambah Berita Baru
        </a>
    </div>
    ...
    <div class="admin-news-tabs">
        ...
        <a href="{{ route('berita') }}" target="_blank" style="margin-left: auto; background: #edf6f5; color: #0f766e; border-color: #0f766e;">
    ...
    <div class="pub-admin-table">
        ...
        @forelse($publikasi as $publication)
            <div class="pub-admin-row">
                ...
                <span>{{ $publication->category ?: 'Berita' }}</span>
                ...
                <div class="pub-actions">
                    ...
                    <form method="POST" action="{{ route('admin.publikasi.destroy', $publication->id) }}" onsubmit="return confirm('Hapus berita ini?')" style="display: inline;">
                        @csrf
                        @method('DELETE')
