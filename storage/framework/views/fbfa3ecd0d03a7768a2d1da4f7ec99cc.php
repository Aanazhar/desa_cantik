<?php $__env->startSection('title', 'Beranda - ' . ($activeDesa->name ?? 'Desa Waha')); ?>
...
<section class="home-hero" 
    style="background: linear-gradient(135deg, rgba(15, 118, 109, 0.9), rgba(138, 144, 158, 0.2)), url('<?php echo e($heroBgImage); ?>') center/cover no-repeat;">
    ...
    <div class="container home-hero-inner">
        ...
        <div class="home-hero-content">
            ...
            <h1>
                <?php echo e($contents['hero_title'] ?? 'Selamat Datang di ' . ($activeDesa->name ?? 'Desa Waha')); ?>

            </h1>

            <p>
                <?php echo e($contents['hero_description'] ?? 'Portal resmi desa untuk memperoleh informasi, data desa, pelayanan administrasi, berita, dan komunikasi masyarakat.'); ?>
            ...
            <div class="hero-buttons">
                <a href="<?php echo e(route('layanan')); ?>" class="btn btn-primary hero-btn-main">
                    📄 Layanan Online <span> </span>
                </a>
                <a href="<?php echo e(route('data-desa')); ?>" class="btn btn-outline hero-btn-sub">
                    📊 Data Desa
                </a>
            </div>
            <p></p>
...
<section class="home-statistics">
    ...
    <div class="container">
        ...
        <div class="home-section-header">
            ...
            <a href="<?php echo e(route('data-desa')); ?>" class="home-section-link">
        ...
        <div class="statistics-grid">
            ...
            <div class="stat-card bounce-card">
                ...
                <div class="stat-content">
                    <strong><?php echo e(number_format((int)($villages?->count() ?? 0), 0, ',', '.')); ?></strong>
            ...
            <div class="stat-card bounce-card">
                ...
                <div class="stat-content">
                    <strong><?php echo e(number_format((int)($statistics?->total_penduduk ?? 0), 0, ',', '.')); ?></strong>
            ...
            <div class="stat-card bounce-card">
                ...
                <div class="stat-content">
                    <strong><?php echo e(number_format((int)($statistics?->kepala_keluarga ?? 0), 0, ',', '.')); ?></strong>
            ...
            <div class="stat-card bounce-card">
                ...
                <div class="stat-content">
                    <strong><?php echo e(number_format((int)($statistics?->laki_laki ?? 0), 0, ',', '.')); ?></strong>
            ...
            <div class="stat-card bounce-card">
                ...
                <div class="stat-content">
                    <strong><?php echo e(number_format((int)($statistics?->perempuan ?? 0), 0, ',', '.')); ?></strong>
    ...
    <div class="container">
        ...
        <div class="about-grid">
            ...
            <div class="about-visual">
                ...
                <div class="about-card float-card">
                    ...
                    <div class="about-card-body">
                        ...
                        <h3>
                            <?php echo e(strtoupper($activeDesa->name ?? 'DESA WAHA')); ?>
            ...
            <div class="about-content">
                ...
                <h2>
                    <?php echo e($contents['about_title'] ?? 'Desa yang terbuka, informatif, dan melayani masyarakat'); ?>

                </h2>

                <p class="about-main-desc">
                    <?php echo e($contents['about_description'] ?? 'Gunakan website ini untuk memperoleh informasi resmi desa, melihat statistik, mengajukan layanan, membaca berita, dan menemukan kontak Pemerintah Desa.'); ?>
                ...
                <a href="<?php echo e(route('profil')); ?>" class="btn-about-link">
...
<section class="section home-services">
    ...
    <div class="container">
        ...
        <div class="home-section-header">
            ...
            <a href="<?php echo e(route('layanan')); ?>" class="home-section-link">
                Lihat Semua Layanan
                <span>→</span>
            </a>
                ...
                <article class="home-service-card bounce-card">
                    ...
                    <div class="home-service-top">
                        ...
                        <span class="home-service-number">
                            LAYANAN <?php echo e(str_pad($index + 1, 2, '0', STR_PAD_LEFT)); ?>
                    ...
                    <div class="home-service-body">
                        ...
                        <p><?php echo e(\Illuminate\Support\Str::limit(strip_tags($service->description), 120)); ?></p>
                    </div>

                    <div class="home-service-footer">
                        <a href="<?php echo e(route('layanan.show', $service->id)); ?>" class="home-service-button">
...
<section class="section home-news">
    ...
    <div class="container">
        ...
        <div class="home-section-header">
            ...
            <a href="<?php echo e(route('berita')); ?>" class="home-section-link">
                Semua Berita
                <span>→</span>
            </a>
                ...
                <article class="home-news-card bounce-card">
                    ...
                    <div class="home-news-image">
                        ...
                        <div class="home-news-placeholder-box">
                            ...
                            <span style="font-size: 0.75rem; font-weight: 800; text-transform: uppercase;"><?php echo e($publication->category ?: 'Berita'); ?></span>
                        </div>

                        <div class="home-news-category">
                            <?php echo e($publication->category ?: 'Informasi'); ?>
                    ...
                    <div class="home-news-body">
                        <div class="home-news-date">
                            ...
                            <?php echo e($publication->created_at ? $publication->created_at->format('d M Y') : 'Informasi Desa'); ?>

                        </div>

                        <h3><?php echo e(\Illuminate\Support\Str::limit($publication->title, 70)); ?></h3>
                        <p><?php echo e($publication->excerpt ?: \Illuminate\Support\Str::limit(strip_tags($publication->content), 130)); ?></p>

                        <a href="<?php echo e(route('publikasi.show', $publication->id)); ?>" class="home-news-link">
                            Baca Selengkapnya
                            <span>→</span>
                        </a>
                    </div>
    ...
    <div class="container">
        ...
        <div class="home-section-header">
            <div class="home-section-title">
                ...
                <p>Panduan lengkap Data Terpadu Sosial Ekonomi Nasional dari BPS untuk masyarakat <?php echo e($activeDesa->name ?? 'Desa Waha'); ?>.</p>
            </div>
        </div>
...
<section class="section home-location">
    ...
    <div class="container">
        ...
        <div class="location-header">
            ...
            <h2>Temukan Lokasi <?php echo e($desaName); ?></h2>
        ...
        <div class="location-card bounce-card">
            ...
            <div class="location-information">
                ...
                <h3><?php echo e($desaName); ?></h3>

                <p><?php echo e($desaAddress ?: 'Lokasi dan alamat desa dapat dilihat melalui peta.'); ?></p>
                ...
                <a href="<?php echo e($googleMapsUrl); ?>" target="_blank" rel="noopener noreferrer" class="btn btn-primary btn-direction">
                    🧭 Petunjuk Arah
                </a>
            ...
            <div class="location-map">
                <?php if($latitude && $longitude): ?>
                    <div id="desa-map" data-lat="<?php echo e($latitude); ?>" data-lng="<?php echo e($longitude); ?>"></div>
                <?php else: ?>
                    <iframe
                        src="https://www.google.com/maps?q=<?php echo e(urlencode($mapQuery)); ?>&output=embed"
                        width="100%"
                        height="100%"
                        style="border:0;"
                        loading="lazy"
                        referrerpolicy="no-referrer-when-downgrade"
                        title="Lokasi <?php echo e($desaName); ?>"
                    ></iframe>
                <?php endif; ?>
            </div>
    ...
    <div class="container">
        ...
        <div class="cta-card bounce-card">
            ...
            <div class="cta-buttons">
                <a href="<?php echo e(route('layanan')); ?>" class="btn btn-primary">📄 Layanan Desa</a>
                <a href="<?php echo e(route('kontak')); ?>" class="btn btn-outline">📞 Hubungi Kami</a>
            </div>
...
<?php if($latitude && $longitude): ?>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            marker.bindPopup('<strong><?php echo e(addslashes($desaName)); ?></strong><br>Lokasi Pemerintah Desa').openPopup();
        });
    </script>
    <?php $__env->stopPush(); ?>
<?php endif; ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp\htdocs\desa_cantik\resources\views/home.blade.php ENDPATH**/ ?>