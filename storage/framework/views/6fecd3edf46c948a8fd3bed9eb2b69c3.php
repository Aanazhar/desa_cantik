<?php $__env->startSection('title', 'Dashboard Admin - ' . ($activeDesa->name ?? 'Desa Waha')); ?>
...
<div class="admin-dashboard-page">
    ...
    <div class="admin-welcome-hero">
        <div>
            ...
            <h2>Selamat Datang, <?php echo e(session('admin_name', 'Administrator')); ?> 👋</h2>
            <p>Kelola data kependudukan, fasilitas, layanan publik, berita, dan transparansi <?php echo e($activeDesa->name ?? 'Desa Waha'); ?>.</p>
        </div>

        <a href="<?php echo e(route('home')); ?>" target="_blank" class="btn-hero-website">
            Lihat Website ↗
        </a>
    </div>
    ...
    <div class="admin-stat-grid">
        ...
        <div class="modern-stat-card">
            ...
            <div class="modern-stat-value">
                <?php echo e(number_format($statistics?->total_penduduk ?? 0, 0, ',', '.')); ?>
        ...
        <div class="modern-stat-card">
            ...
            <div class="modern-stat-value">
                <?php echo e(number_format($statistics?->kepala_keluarga ?? 0, 0, ',', '.')); ?>
        ...
        <div class="modern-stat-card">
            ...
            <div class="modern-stat-value">
                <?php echo e(number_format($villages ?? 0, 0, ',', '.')); ?>
        ...
        <div class="modern-stat-card">
            ...
            <div class="modern-stat-value">
                <?php echo e(number_format($services ?? 0, 0, ',', '.')); ?>
    ...
    <div class="admin-dashboard-columns">
        ...
        <div class="admin-panel">
            <div class="admin-panel-header">
                ...
                <a href="<?php echo e(route('admin.data-desa')); ?>" class="admin-panel-link">
                    Kelola Data →
                </a>
            </div>
            ...
            <div class="population-list">
                ...
                <div class="population-item">
                    <div class="population-heading">
                        ...
                        <strong><?php echo e(number_format($male, 0, ',', '.')); ?> Jiwa</strong>
                    </div>
                    <div class="population-bar">
                        <div class="population-fill male" style="width: <?php echo e($malePercent); ?>%;"></div>
                    </div>
                    <small><?php echo e($malePercent); ?>% dari total populasi desa</small>
                </div>
                ...
                <div class="population-item">
                    <div class="population-heading">
                        ...
                        <strong><?php echo e(number_format($female, 0, ',', '.')); ?> Jiwa</strong>
                    </div>
                    <div class="population-bar">
                        <div class="population-fill female" style="width: <?php echo e($femalePercent); ?>%;"></div>
                    </div>
                    <small><?php echo e($femalePercent); ?>% dari total populasi desa</small>
                </div>
                ...
                <div class="population-item">
                    <div class="population-heading">
                        ...
                        <strong><?php echo e(number_format($statistics?->kepala_keluarga ?? 0, 0, ',', '.')); ?> KK</strong>
                    </div>
                </div>
        ...
        <div class="admin-panel">
            ...
            <div class="quick-menu">
                ...
                <a href="<?php echo e(route('admin.site-data')); ?>" class="quick-menu-item">
                ...
                <a href="<?php echo e(route('admin.data-desa')); ?>" class="quick-menu-item">
                ...
                <a href="<?php echo e(route('admin.layanan')); ?>" class="quick-menu-item">
                    <div class="quick-icon">📄</div>
                    <div>
                ...
                <a href="<?php echo e(route('admin.publikasi.index')); ?>" class="quick-menu-item">
                    <div class="quick-icon">📚</div>
                    <div>
                ...
                <a href="<?php echo e(route('admin.kontak.index')); ?>" class="quick-menu-item">
                    <div class="quick-icon">📞</div>
                    <div>
    ...
    <div class="admin-website-status">
        <div class="status-left">
            ...
            <div>
                <strong>Sistem Website <?php echo e($activeDesa->name ?? 'Desa Waha'); ?> Aktif</strong>
                <span>Informasi yang Anda simpan akan langsung diperbarui secara realtime di halaman publik.</span>
            </div>
        </div>

        <a href="<?php echo e(route('home')); ?>" target="_blank" class="btn-open-site">
            Buka Portal Website ↗
        </a>
    </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp\htdocs\desa_cantik\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>