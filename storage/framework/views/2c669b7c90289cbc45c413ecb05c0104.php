<?php $__env->startSection('title', 'Layanan Desa - ' . ($activeDesa->name ?? 'Desa Waha')); ?>
    ...
    <section class="page-hero">
        <div class="container page-hero-flex">
            ...
            <div class="page-hero-action">
                <a href="<?php echo e(route('layanan.status')); ?>" class="btn-check-status-hero">
    ...
    <section class="section">
        <div class="container">
            ...
            <div class="service-picker-grid">
                <?php $__empty_1 = true; $__currentLoopData = $letters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <article class="service-card-modern service-picker">
                        ...
                        <div class="service-card-requirements">
                            ...
                            <ul>
                                <?php $__empty_2 = true; $__currentLoopData = array_slice($service->requirements ?? [], 0, 4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $req): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
            ...
            <div id="form-pengajuan" class="letter-request-panel" style="display: none;">
                ...
                <form method="POST" action="<?php echo e(route('layanan.pengajuan-surat')); ?>">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="dynamic-form-grid">
                        <div class="admin-form-group">
                            ...
                            <input name="nama" required value="<?php echo e(old('nama')); ?>" placeholder="Masukkan nama lengkap sesuai KTP">
                        </div>

                        <div class="admin-form-group">
                            <label>No. HP / WhatsApp *</label>
                            <input name="no_hp" required value="<?php echo e(old('no_hp')); ?>" placeholder="Contoh: 081234567890">
                        </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp\htdocs\desa_cantik\resources\views/layanan.blade.php ENDPATH**/ ?>