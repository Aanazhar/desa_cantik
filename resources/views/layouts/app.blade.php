...
<head>
    ...
    <title>
        @yield('title', ($activeDesa->name ?? 'Desa Waha')) - Website Resmi Desa
    </title>

    <meta name="description" content="Website Resmi Pemerintah {{ $activeDesa->name ?? 'Desa Waha' }}">
    ...
    <nav class="navbar">
        <div class="container nav-container">
            ...
            <a href="{{ route('home') }}" class="logo">
                <img 
                    src="{{ asset('images/logo Kabupaten Wakatobi (2).png') }}" 
                    alt="Logo {{ $activeDesa->name ?? 'Desa Waha' }}" 
                    style="height: 44px; width: auto; object-fit: contain;"
                >

                <div class="logo-text">
                    <strong>{{ strtoupper($activeDesa->name ?? 'DESA WAHA') }}</strong>
            ...
            <div class="nav-menu">
                ...
                <a href="{{ route('data-desa') }}" class="nav-link {{ request()->routeIs('data-desa*', 'data.page') ? 'active' : '' }}">
                    Data Desa
                </a>
                ...
                <a href="{{ route('publikasi') }}" class="{{ request()->routeIs('publikasi*') ? 'active' : '' }}">
                    Publikasi
                </a>
...
{{-- =========================================================
     🌙 FOOTER PRESTISIUS DESA CANTIK (SAMAKAN PHPMYADMIN & FOTO)
     ========================================================= --}}
<footer class="site-footer">
    <div class="container">
        <div class="footer-grid-container">
            
            {{-- KOLOM 1: IDENTITAS DESA CANTIK --}}
            <div>
                <div class="footer-brand">
                    <img src="{{ asset('images/logo Kabupaten Wakatobi (2).png') }}" alt="Logo Wakatobi">
                    <div class="footer-brand-text">
                        <strong>Desa Cantik</strong>
                        <span>{{ $activeDesa->name ?? 'Desa Waha' }}</span>
                    </div>
                </div>
            ...
            <div>
                ...
                <ul class="footer-links-list">
                    <li><a href="{{ route('home') }}"><span style="color: #10b981;">•</span> Beranda</a></li>
                    <li><a href="{{ route('data-desa') }}"><span style="color: #10b981;">•</span> Data Statistik</a></li>
                    <li><a href="{{ route('layanan') }}"><span style="color: #10b981;">•</span> Layanan Online</a></li>
                    <li><a href="{{ route('publikasi') }}"><span style="color: #10b981;">•</span> Publikasi & Berkas</a></li>
                    <li><a href="{{ route('berita') }}"><span style="color: #10b981;">•</span> Berita Desa</a></li>
                    <li><a href="{{ route('profil') }}"><span style="color: #10b981;">•</span> Tentang Kami</a></li>
                </ul>
            </div>

            {{-- KOLOM 3: WEBSITE PENDUKUNG --}}
            <div>
            ...
            <div>
                ...
                <div class="footer-contact-item">
                    ...
                    <span>{{ $activeDesa->address ?? 'Kecamatan Wangi-Wangi, Kabupaten Wakatobi, Sulawesi Tenggara' }}</span>
                </div>
                <div class="footer-contact-item">
                    <span class="contact-icon-green">📞</span>
                    <span>{{ $activeDesa->phone ?? '081234567890' }}</span>
                </div>
                <div class="footer-contact-item">
                    <span class="contact-icon-green">✉️</span>
                    <span>{{ $activeDesa->email ?? ('desawaha@wakatobikab.go.id') }}</span>
                </div>
            </div>
        ...
        <div class="footer-bottom-bar">
            <div>
                © {{ date('Y') }} {{ $activeDesa->name ?? 'Desa Waha' }}. Hak Cipta Dilindungi.
            </div>
            <div>
