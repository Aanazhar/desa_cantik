...
<head>
    ...
    <title>
        @yield('title', 'Dashboard') - {{ $activeDesa->name ?? 'Desa Waha' }}
    </title>
...
<div class="admin-layout">
    ...
    <aside class="admin-sidebar" id="adminSidebar">
        ...
        {{-- BRAND LOGO PERMANEN & DINAMIS --}}
                {{-- LOGO NAVBAR PUBLIK (KABUPATEN WAKATOBI) --}}
        ...
        <nav class="admin-nav">
            ...
            {{-- PROFIL DESA --}}
            <a href="{{ route('admin.desa-profiles') }}" class="admin-nav-link {{ request()->routeIs('admin.desa-profiles*') || request()->routeIs('admin.desa-profile-sections*') ? 'active' : '' }}">
                <span class="admin-nav-icon">🏡</span>
                <span>Profil Desa</span>
            </a>
<!-- 
            {{-- DATA WEBSITE --}}
            <a href="{{ route('admin.site-data') }}" class="admin-nav-link {{ request()->routeIs('admin.site-data*') ? 'active' : '' }}">
                <span class="admin-nav-icon">
                    <svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" stroke-width="2">
            ...
            <div class="admin-nav-dropdown {{ (request()->routeIs('admin.layanan*') || request()->routeIs('admin.pengajuan*')) ? 'open' : '' }}">
                <button type="button" class="admin-nav-link admin-dropdown-toggle" aria-expanded="{{ (request()->routeIs('admin.layanan*') || request()->routeIs('admin.pengajuan*')) ? 'true' : 'false' }}">
                    <span class="admin-nav-icon">
                        <svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" stroke-width="2">
                ...
                <div class="admin-dropdown-menu">
                    ...
                    <a href="{{ route('admin.layanan') }}#tambah-layanan">
            ...
            {{-- PUBLIKASI & DOKUMEN --}}
            <a href="{{ route('admin.publikasi.index') }}" class="admin-nav-link {{ request()->routeIs('admin.publikasi*') && !request()->routeIs('admin.berita*') ? 'active' : '' }}">
                <span class="admin-nav-icon">
                    <svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" stroke-width="2">
            ...
            {{-- KONTAK --}}
            <a href="{{ route('admin.kontak.index') }}" class="admin-nav-link {{ request()->routeIs('admin.kontak*') ? 'active' : '' }}">
                <span class="admin-nav-icon">
                    <svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" stroke-width="2">
    ...
    <main class="admin-main">
        ...
        <header class="admin-topbar">
            ...
            <div class="admin-topbar-right">
                <a href="{{ route('home') }}" target="_blank" class="admin-view-site">Lihat Website</a>
